	...
	<table>
		...
		<td style="padding:3px"><input type="text" name="email" id="email" size="24" 
				   ...
				   <tr>
					...
					<tr>
					   <td align="right">Password(<a href="#dialog2" name="modal">Hint</a>)<span style="color:red;">*</span> :</td>
...
<a href="#" class="close"><img src="{$BASE_URL}_templates/default/img/Close_icon.png" class="btn_closes" title="Close Window" alt="Close" /></a>
 An effective and secure password must contain a combination of uppercase, lowercase, numeric and special characters. Please construct a strong password with the following:
 </br>
&bull;Minimum length of 8 characters</br>
&bull;One uppercase character (Eg.X,Y,Z etc.)</br>
&bull;One lowercase character (Eg., x, y, z, etc.)</br>
&bull;One numeric character (Eg., 9, 7, 2, etc.)</br>
&bull;One special character (Eg., _, @, *, etc.)
</div>
<div id="mask"></div>
</div>
</table>
...
<table>
	...
	<td>
		...
		<td style="padding-left:3px;" >
			...
			<input type="image" id="comapanylogos1" src="{$BASE_URL}_templates/{$THEME}/img/IBM_1.png"/></td>
			</a>
		</td>
		<td style="padding-left:3px;">
			<a href="http://www.microsoft.com/careers/."target="_blank" >
			<input type="image" id="comapanylogos1" src="{$BASE_URL}_templates/{$THEME}/img/Microsoft_1.png"/></td>
			</a>
		</td>
		<td style="padding-left:3px;">
			<a href="http://www.cisco.com/web/about/ac40/about_cisco_careers_home.html" target="_blank">
			<input type="image" id="comapanylogos1" src="{$BASE_URL}_templates/{$THEME}/img/Cisco_1.png"/></td>
			</a>
		</td>
		</tr>
		<tr>
		<td style="padding-left:3px;">
			...
			<input type="image" id="comapanylogos1" src="{$BASE_URL}_templates/{$THEME}/img/HP_1.png"/></td>
			</a>
		</td>
		<td style="padding-left:3px;">
			<a href="http://www.tcs.com/careers/."target="_blank" >
			<input type="image" id="comapanylogos1" src="{$BASE_URL}_templates/{$THEME}/img/TCS_1.png"/></td>
			</a>
		</td>
		<td style="padding-left:3px;">
			<a href="http://www.infosys.com/careers/."target="_blank" >
			<input type="image" id="comapanylogos1" src="{$BASE_URL}_templates/{$THEME}/img/Infosys_1.png"/></td>
			</a>
		</td>
		</tr>
		<tr><td style="padding-left:3px;">
			<a href="http://www.wipro.com/careers/."target="_blank" >
			<input type="image" id="comapanylogos1" src="{$BASE_URL}_templates/{$THEME}/img/Wipro_1.png"/></td>
			</a>
		</td>
		<td style="padding-left:3px;">
		<a href="http://www.cognizant.com/careers/" target="_blank" >
			<input type="image" id="comapanylogos1" src="{$BASE_URL}_templates/{$THEME}/img/Cognizant_1.png"/></td>
		</a>
		</td>
		<td style="padding-left:3px;">
			<a href="http://www.hcl.in/careers.asp" target="_blank" >
			<input type="image" id="comapanylogos1" src="{$BASE_URL}_templates/{$THEME}/img/HCL_1.png"/></td>
			</a>
		</td>
		</tr>
		<tr>
		<td style="padding-left:3px;">
			...
			<input type="image" id="comapanylogos1" src="{$BASE_URL}_templates/{$THEME}/img/CG_1.png"/></td>
			</a>
		</td>
		<td style="padding-left:3px;">
			<a href="http://www.convergys.com/company/careers/" target="_blank">
			<input type="image" id="comapanylogos1" src="{$BASE_URL}_templates/{$THEME}/img/Convergys_1.png"/></td>
			</a>
		</td>
		<td style="padding-left:3px;">
			<a href="http://www.techmahindra.com/tech_mahindra_careers/tech_mahindra_jobs.aspx"target="_blank" >
			<input type="image" id="comapanylogos1" src="{$BASE_URL}_templates/{$THEME}/img/TM_1.png"/></td>
			</a>
		</td>
		</tr>
		</table>
