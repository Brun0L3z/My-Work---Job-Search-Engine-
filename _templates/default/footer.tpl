	...
	<div class="footer">
		<div id="footer-contents">
			...
			Copyright &copy; 2012 TechIndya. All Rights Reserved.
				{$translations.footer.powered_by}
				<a href="http://www.scan4jobs.com/" title="open source job board software">scan4jobs</a>
			</div>-->

			<div class="clear"></div>
			<div id="copyright">
				<a href="{$BASE_URL}about/" title="About Us" ><span style="color:#0070C0;padding-top:5px;">About Us</span></a>
				| <a href="{$BASE_URL}contact/" title="Contact Us" ><span style="color:#0070C0;">Contact Us</span></a> |
				<a href="{$BASE_URL}privacy/" title="Privacy and Policy" ><span style="color:#0070C0;">Privacy Policy</span></a> |
				&copy;2012 TechIndya. All Rights Reserved.
				</a>
			</div>
		</div><!-- #footer-contents -->
	</div><!-- .footer -->
