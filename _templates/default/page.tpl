...
<div id="serviceborder">
		...
		<p>
			<img src="{$BASE_URL}_templates/{$THEME}/img/under.png" alt="" />
		</p>
		{else}
		...
		<div id="content">
			...
			<div id="contact-form">
				<div id="contact-form-contents">
					<form  method="post" action="{$BASE_URL}{$page.url}/">
						...
						{/if}
						<br /><br />
<input type="image" src="{$BASE_URL}_templates/{$THEME}/img/sendmessage.png" value=""/>
