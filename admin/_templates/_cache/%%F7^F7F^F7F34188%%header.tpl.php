...
industries/list/">Industries</a></li>
			 <li><a href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
area/list/">Functional Area</a></li>
			 <li><a href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
qualification/list/">Qualification</a></li>
			 <li><a href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
education/list/">Education Specialization</a></li>
			  <li><a href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
cities/list/">Cities and States</a></li>
		</ul>
	 </li>
...
/"><?php echo $this->_tpl_vars['settings_categories'][$this->_sections['index']['index']]['name']; ?>
	 ...
	 <?php endfor; endif; ?>
	 <li><a href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
clear-cache/">Clear Cache</a></li>
	 </ul>
	 </li>
	  <li><a <?php if ($this->_tpl_vars['CURRENT_PAGE'] == 'features'): ?>class="selected"<?php endif; ?> href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
features/">Features</a>
	  <ul>
	  <li><a href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
search/">Simple Search</a></li>
	  <li><a href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
advance_search/">Advance Search</a></li>
	  <li><a <?php if ($this->_tpl_vars['CURRENT_PAGE'] == 'spam'): ?>class="selected"<?php endif; ?>  href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
spam/">Fake Reports</a></li>
	   <li><a <?php if ($this->_tpl_vars['CURRENT_PAGE'] == 'userothers'): ?>class="selected"<?php endif; ?> href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
userothers/">Other Values</a></li>
	   <li><a <?php if ($this->_tpl_vars['CURRENT_PAGE'] == 'user'): ?>class="selected"<?php endif; ?> href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
user/">Users list</a></li>
	  </ul>
	  </li>
