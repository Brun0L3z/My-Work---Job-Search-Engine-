...
<body>
	...
	{/if}
	 ...
	 <h1>Scan4Jobs Administration</h1>
	...
	{if $isAuthenticated == 1}
	 ...
	 <li><a {if $CURRENT_PAGE == 'cities'}class="selected"{/if} href="{$BASE_URL_ADMIN}boxes/">Lists</a>
		 <ul>
			 <li><a href="{$BASE_URL_ADMIN}industries/list/">Industries</a></li>
			 <li><a href="{$BASE_URL_ADMIN}area/list/">Functional Area</a></li>
			 <li><a href="{$BASE_URL_ADMIN}qualification/list/">Qualification</a></li>
			 <li><a href="{$BASE_URL_ADMIN}education/list/">Education Specialization</a></li>
			  <li><a href="{$BASE_URL_ADMIN}cities/list/">Cities and States</a></li>
		</ul>
	 </li>
	 ...
	 <li><a href="{$BASE_URL_ADMIN}clear-cache/">Clear Cache</a></li>
	  ...
	  <li><a {if $CURRENT_PAGE == 'features'}class="selected"{/if} href="{$BASE_URL_ADMIN}features/">Features</a>
	  <ul>
	  <li><a href="{$BASE_URL_ADMIN}search/">Simple Search</a></li>
	  <li><a href="{$BASE_URL_ADMIN}advance_search/">Advance Search</a></li>
	  <li><a {if $CURRENT_PAGE == 'spam'}class="selected"{/if}  href="{$BASE_URL_ADMIN}spam/">Fake Reports</a></li>
	   <li><a {if $CURRENT_PAGE == 'userothers'}class="selected"{/if} href="{$BASE_URL_ADMIN}userothers/">Other Values</a></li>
	   <li><a {if $CURRENT_PAGE == 'user'}class="selected"{/if} href="{$BASE_URL_ADMIN}user/">Users list</a></li>
	  </ul>
	  </li>
