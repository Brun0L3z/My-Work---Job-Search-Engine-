...
switch($page)
{
	...
	require_once 'page_detaillogin.php';
	  ...
	  break;
	case 'forgotpassword':
	require_once 'page_forgotpassword.php';
	  $flag = 1;
	  break;
 /*Applyed jobs*/
		  case 'applyedjobs':
		require_once 'applyedjobs.php';
		  $flag = 1;
		  break;
	case 'job_search':
		$smarty->assign('login' ,$_SESSION['UserId']);
...
case 'success':
	...
	case 'sitemap.txt':
		...
		case 'changepassword':
			$smarty->assign('login' ,$_SESSION['UserId']);
			require_once 'page_changepassword.php';			
			$flag = 1;
			break;
