...
require_once APP_PATH . '_includes/class.Register.php';
require_once APP_PATH . '_includes/class.User.php';
require_once APP_PATH . '_includes/class.way2sms.php';
require_once APP_PATH . '_includes/class.Userlist.php';
require_once APP_PATH . '_includes/class.Useredit.php';
